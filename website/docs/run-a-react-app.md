...
We'll now look at an op to run a sample React application. Please see the code at [https://github.com/soultech67/opctl/tree/main/examples/run-a-react-app](https://github.com/soultech67/opctl/tree/main/examples/run-a-react-app)
