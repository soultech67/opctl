...
We'll now look at an op to run a sample Go application. Please see the code at [https://github.com/soultech67/opctl/tree/main/examples/run-a-go-service](https://github.com/soultech67/opctl/tree/main/examples/run-a-go-service)
